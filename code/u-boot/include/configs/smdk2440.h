...
#define PHYS_FLASH_SIZE		0x00200000 /* 8MB */
#define CONFIG_SYS_MAX_FLASH_SECT	(35)	/* max number of sectors on one chip */
#define CONFIG_ENV_ADDR		(CONFIG_SYS_FLASH_BASE + 0x020000) /* addr of environment */
#endif 
...
#define NAND_SECTOR_SIZE_2K             NAND_SECTOR_SIZE
